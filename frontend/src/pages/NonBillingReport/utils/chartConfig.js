/**
 * Non-Billing Report Chart Configurations
 */
 ...
 */
export const createTrackDonutChartData = (trackData) => {
  ...
  return {
    ...
    datasets: [{
      ...
      backgroundColor: [colors.secondary, colors.primary, colors.gray, colors.purple, colors.cyan],
      borderWidth: 2,
      borderColor: '#fff',
    }],
  };
