    ...
    try {
      ...
      if (isEditMode) {
        const updatePayload = {
          ...
          total_allocation: values.total_allocation !== undefined && values.total_allocation !== null ? values.total_allocation : 0,
          total_resource_billing: values.total_resource_billing !== undefined && values.total_resource_billing !== null ? values.total_resource_billing : 0,
